...
sim1 <- gen_balanced_datasets_long(nreps = num_datsets, nSubjs = sample_size, num_obs = 5, sdErr = 10, 
...
#240 subjects
sim2 <- gen_balanced_datasets_long(nreps = num_datsets, nSubjs = sample_size, num_obs = 5, sdErr = 10, 
                              # intercept and slope fixed effects
                              coef1 = c(4, 3),
                              # types of level 2 covariates
                              level2Binary = c(0.2, 0.4),
