...
results2 <- stan_output_extract(results)
results2[[1]]
results3 <- rmse_function(results2, split$Testing)
results4 <- cleaning(results3)

#50
dat <- gen_lots_data(nreps = 5,nSubjs = 50, sdErr = 10, 
                     # intercept and slope fixed effects
                     coef1 = c(4, 3),
                     # types of level 2 covariates
                     level2Binary = c(.2, 0.7),
...
#100
dat <- gen_lots_data(nreps = 5,nSubjs = 100, sdErr = 10, 
                     # intercept and slope fixed effects
                     coef1 = c(4, 3),
                     # types of level 2 covariates
                     level2Binary = c(.2, 0.7),
...
#500
dat <- gen_lots_data(nreps = 5,nSubjs = 500, sdErr = 10, 
                     # intercept and slope fixed effects
                     coef1 = c(4, 3),
                     # types of level 2 covariates
                     level2Binary = c(.2, 0.7),
